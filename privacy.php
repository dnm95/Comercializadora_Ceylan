  ...
  <nav class="breadcrumb-menu blue-grey lighten-1">
        <div class="nav-wrapper">
            <div class="col s12">
                ...
                <a href="privacy.php" class="breadcrumb">Política de privacidad</a>
            </div>
        </div>
  </nav>
  ...
  <div class="section no-pad-bot" id="index-banner">
    <div class="container">
      ...
      <p>
        ...
        *Proveer los productos y servicios requeridos por usted.<br />
        *Dar cumplimiento a las obligaciones fiscales contraídas producto de las actividades comerciales.<br /><br />
        ...
        *Dar respuesta a los particulares que hagan contacto con la empresa y brindar una completa atención al cliente.<br />
        *Reclutamiento y verificación de identidad.<br /><br />

        Comercializadora Ceylán podrá modificar el presente aviso de privacidad en cualquier tiempo y lo mantendrá siempre a disposición en su pagina de Internet para consulta.
      </p>
      <h4 class="center-align">Ampliación de Google Analytics</h4>
      <p>
